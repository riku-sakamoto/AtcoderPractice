...
string solve(){
    ...
    vector<int> first_colors(n);
    vector<int> end_colors(n);

    first_colors[0] = 1;
    FOR(i, 1, n){
        if(colors[i] == colors[0]){
            first_colors[i] = first_colors[i - 1] + 1;
        }else{
            first_colors[i] = first_colors[i - 1];
        }
    }
    ...
    REPREV(i, n - 1){
        if(colors[i] == colors[n - 1]){
            end_colors[i] = end_colors[i + 1] + 1;
        }else{
            end_colors[i] = end_colors[i + 1];
        }
    }
