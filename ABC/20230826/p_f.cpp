...
int main(){
    ...
    vector<vector<mint>> A1(64, vector<mint>(A[0], 0LL));
    vector<vector<mint>> A2(64, vector<mint>(A[1], 0LL));
    vector<vector<mint>> A3(64, vector<mint>(A[2], 0LL));

    REP(i, 64){
        LL val = calcPow(2LL, i, 1LL);
