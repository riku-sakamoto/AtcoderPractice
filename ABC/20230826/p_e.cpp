...
int main(){
    ...
    while(!que.empty()){
        ...
        for(auto d: dirs){
            ...
            if(A[next_i][next_j] == '.' || A[next_i][next_j] == 'G'){
                que.push({next_i, next_j, c + 1});
