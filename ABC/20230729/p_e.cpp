...
int main(){
    int N; cin >> N;
    vector<vector<int>> coords(N, vector<int>(6));
    REP(i, N){
        REP(j, 6){
            cin >> coords[i][j];
        }
    ...
    vector<vector<set<int>>> XY(101, vector<set<int>>(101));
    vector<vector<set<int>>> YZ(101, vector<set<int>>(101));
    vector<vector<set<int>>> ZX(101, vector<set<int>>(101));
